  ...
  return (
    <>
      <PageHeader
        ...
        description="Vista preparada per filtrar participants per territori, perfil linguistic, estat de consentiment i taxa de completitud."
      />

      <SectionCard
        title="Registre recent"
        description="Lectura rapida del pool de participants."
      >
